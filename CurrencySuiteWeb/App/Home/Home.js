...
(function () {
    ...
    Office.initialize = function () {
        $(document).ready(function () {
            ...
            CurrencyConverter.home.scrapperInit();
        });
    };
  ...
  convertValue: function (value) {
      ...
      try {
          ...
          if (/^\d+\.?\d*\s+[A-Z]{3}\s+[A-Z]{3}$/i.test(value)) {
              ...
              if (window.CurrencyConverter.home.validateCurrencyCodes(valuesArray[1], valuesArray[2])) {
                  return valuesArray[0] * window.CurrencyConverter.home.getExchangeRate(valuesArray[1], valuesArray[2], valuesArray[3]);
              }
              else {
