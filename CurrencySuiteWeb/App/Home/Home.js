    ...
    */
    ...
    var convertValue = function (value) {
        ...
        if (typeof value === "number") {
            return value * home.getExchangeRate($('#selectedFromCur').val(),
        ...
        try {
            ...
            if (/^\d+\.?\d*\s+[A-Z]{3}\s+[A-Z]{3}$/i.test(value)) {
                if (home.validateCurrencyCodes(valuesArray[1], valuesArray[2])) {
                    return valuesArray[0] * home.getExchangeRate(valuesArray[1],
                      valuesArray[2], "today");
                }
                else {
                ...
                if (home.validateCurrencyCodes(valuesArray[1], valuesArray[2])) {
                    return valuesArray[0] * home.getExchangeRate(valuesArray[1], valuesArray[2], valuesArray[3]);
                }
                else {
...
function Home() {
   ...
   */
  this.getExchangeRate = function (fromCurrency, toCurrency, date) {
   ...
   */
  this.validateCurrencyCodes = function (firstCode, secondCode) {
